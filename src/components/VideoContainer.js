  ...
  return (
    <div>
        <div className="absolute w-1/2 h-screen flex flex-col justify-center pl-10 bg-gradient-to-r gap-8 from-black text-white">
            ...
            <div>
                <button className="py-4 text-xl px-10 rounded-lg bg-slate-400 ">▶ Play</button>
                <button className="py-4 text-xl px-10 rounded-lg bg-slate-400 ml-4 ">ℹ More Info</button>
            </div>
        </div>
